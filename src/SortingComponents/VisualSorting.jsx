  ...
  return (
    <div className="visuals">
      <div className="visualizer">
         {myState.algorithm==='quick' && <div className="legend"><div className="legend__table"></div> Pivot elements</div>}
         {
      ...
      <div className="visual__btns">
         <button id = 'change-btn' onClick = {changeValues}>Regenerate Values</button>   
         <button id='play-btn' onClick = {() => handlePlayPause(true)}>Start</button>
      </div>
